...
export default function AnimatedModalDemo() {
  ...
  return (
    <div className="w-auto flex items-center justify-center text-white">
      <Modal>
        <ModalTrigger className="bg-black dark:bg-white dark:text-black text-white flex justify-center group/modal-btn font-bold min-w-[110px]">
